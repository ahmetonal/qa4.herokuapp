...
public class GS_TeamInfo_DB_StepDefs {
	...
	public void system_should_display_all_member_of_the_and_retrieve_teams_information_with_db(String team) {
        ...
        String actualFirstname1 = mePage.firstUser.getText().split(" ")[0];
		String actualLastname1 = mePage.firstUser.getText().split(" ")[1];
		
		String actualFirstname2 = mePage.secondUser.getText().split(" ")[0];
		String actualLastname2 = mePage.secondUser.getText().split(" ")[1];
		
		String actualFirstname3 = mePage.thirdUser.getText().split(" ")[0];
		String actualLastname3 = mePage.thirdUser.getText().split(" ")[1];
		
		String actualFirstname4 = mePage.fourthUser.getText().split(" ")[0];
		String actualLastname4 = mePage.fourthUser.getText().split(" ")[1];
